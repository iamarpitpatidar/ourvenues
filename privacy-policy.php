        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3">
                    <p>This privacy notice discloses the privacy practices for OurVenues(including all its subdomains). This privacy notice applies solely to information collected by this website.</p>
                    ...
                    <h5>If you feel that we are not abiding by this privacy policy, you should contact us immediately via telephone at 738-988-6274 or via email (support@ourvenues.in).</h5>
                </div>
            </div>
        </div>
    </div>
